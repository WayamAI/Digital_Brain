    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation }) => {
          if (orientation === "left") {
            return <AppIcon name="chevronLeft" size="md" className={className} />;
          }

          if (orientation === "right") {
            return <AppIcon name="chevronRight" size="md" className={className} />;
          }

          return <AppIcon name="chevronDown" size="md" className={className} />;
        },
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-brand data-[selected-single=true]:text-brand-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-brand data-[range-start=true]:text-brand-foreground data-[range-end=true]:bg-brand data-[range-end=true]:text-brand-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-auto w-full min-w-(--cell-size) flex-col gap-1 font-normal leading-none data-[range-end=true]:rounded-lg data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-lg group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className,
      )}
      {...props}
